            ...
            <div class="row">
                ...
                @endif
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('dashboard.store.content') }}" method="POST" enctype="multipart/form-data" class="was-validate">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select name="event_category" id="province" class="form-control" required>
